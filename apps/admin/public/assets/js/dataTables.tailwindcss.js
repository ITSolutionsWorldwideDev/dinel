...
$.extend( true, DataTable.ext.classes, {
	...
	length: {
		select: "border text-xs !h-[30px] !bg-white rounded-lg !border-border-color focus:border-border-color focus:shadow-none focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:focus:border-blue-500"
	},
	processing: {
