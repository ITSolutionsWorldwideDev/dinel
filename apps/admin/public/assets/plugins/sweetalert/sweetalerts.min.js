$(document).ready(function () {
  $("#basic-alert").on("click", function () {
    Swal.fire({
      ...
      buttonsStyling: false, // Disable SweetAlert2 styles
      customClass: {
        confirmButton: "btn bg-primary border border-primary text-white text-center hover:bg-primary-hover hover:text-white"
      }
    });
  }),
    ...
    $("#position-top-start").on("click", function () {
      Swal.fire({
        ...
        showConfirmButton: !1,
        timer: 1500,
        confirmButtonClass: "btn bg-primary border border-primary text-white text-center hover:bg-primary-hover hover:text-white",
        buttonsStyling: !1,
      });
    }),
