  ...
  var DataBasicPlugin = function(context) {
    ...
    self.initialize = function() {
      ...
      var body = '<div class="form-group row-fluid">' +
          ...
          '</div>';
      var footer = '<button href="#" class="btn bg-primary border border-primary text-white text-center hover:bg-primary-hover hover:text-white ext-databasic-save">' + lang.databasic.insert + '</button>';
