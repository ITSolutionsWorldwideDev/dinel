// apps/admin/components/disciplines/disciplinesList.tsx
"use client";
...
export default function DisciplineListComponent() {
  ...
  const openEditModal = (record: Discipline) => {
    setIsEditMode(true);
    setFormData({
  ...
  const handleSubmit = async () => {
    try {
      ...
      const res = await fetch("/api/disciplines", {
        ...
        body: JSON.stringify(
          isEditMode
            ? { discipline_id: formData.discipline_id, ...payload }
            : payload
        ),
      });
      ...
      showToast(
        "success",
        isEditMode ? "Discipline updated" : "Discipline created"
      );
      ...
      showToast("error", "Failed to save Discipline");
    }
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      await fetch(`/api/disciplines?id=${selectedId}`, {
        method: "DELETE",
      });
    ...
    },
    {
      ...
      render: (_: any, record: Discipline) => (
        <div className="flex gap-2">
          ...
          <button
            onClick={() => {
              setSelectedId(record.discipline_id);
      ...
      <div className="page-wrapper">
        <div className="content">
          <div className="page-header flex justify-between items-center mb-4">
            <div>
              <h4 className="text-lg font-semibold">Discipline List</h4>
          ...
          <div className="modal-content modal-content-demo bg-white rounded w-full max-w-lg">
            <div className="modal-header flex">
              <h4 className="modal-title">
                {isEditMode ? "Edit Discipline" : "Add Discipline"}
              </h4>
              <Button
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white rounded p-6 text-center max-w-sm">
            ...
            <h4 className="font-bold mb-2">Delete Discipline</h4>
