...
export const jobCategories: JobCategoryGroup[] = [
  ...
  requirements: [
    { en: "You are an organizer pur sang who easily switches between different activities and stakeholders. You keep an overview, work accurately and always think one step ahead. In addition, you have:", nl: "Je bent een organisator pur sang die gemakkelijk schakelt tussen verschillende werkzaamheden en stakeholders. Je behoudt het overzicht, werkt nauwkeurig en denkt altijd een stap vooruit. Daarnaast heb je:" },
    ...
    { en: "Nice to Have: Good command of both Dutch and English", nl: "Nice to Have: Goede beheersing van de Nederlandse én Engelse taal" },
    { en: "Nice to Have: A proactive attitude and strong communication skills", nl: "Nice to Have: Een proactieve houding en sterke communicatieve vaardigheden" },
  ],
},
     {
  ...
  requirements: [
    ...
    { en: "Nice to Have: Affinity with systems such as SAP EWM is a plus", nl: "Nice to Have: Affiniteit met systemen zoals SAP EWM is een pré" },
    { en: "Nice to Have: Good command of both Dutch and English", nl: "Nice to Have: Goede beheersing van zowel de Nederlandse als Engelse taal" },
  ],
},
     {
  ...
  requirements: [
    ...
    { en: "Nice to Have: Good communication skills and the confidence to work with various stakeholders", nl: "Nice to Have: Goede communicatieve vaardigheden en het zelfvertrouwen om met verschillende stakeholders samen te werken" },
    { en: "Nice to Have: A proactive, pragmatic and no-nonsense approach", nl: "Nice to Have: Een proactieve, pragmatische en no-nonsense aanpak" },
    { en: "Nice to Have: Fluent command of Dutch is required", nl: "Nice to Have: Vloeiende beheersing van het Nederlands is verplicht" },
    { en: "Nice to Have: Attention to detail and a quality-oriented mindset", nl: "Nice to Have: Oog voor detail en een kwaliteitsgerichte instelling" },
  ],
},
      {
  ...
  requirements: [
    ...
    { en: "Nice to Have: ITIL Foundation certification or structured service-desk experience is a plus", nl: "Nice to Have: ITIL Foundation certificering of structured service-desk ervaring is een pré" },
    { en: "Nice to Have: Experience with WMS or industrial ERP environments is a plus", nl: "Nice to Have: Ervaring met WMS of industriële ERP-omgevingen is een pré" },
    { en: "Nice to Have: Familiarity with database management concepts and analytics platforms (Excel / Power BI)", nl: "Nice to Have: Bekendheid met database management concepten en analytics platforms (Excel / Power BI)" },
  ],
},
      {
      ...
      },
 {
  ...
  requirements: [
    ...
    { en: "Strong analytical mindset with excellent attention to detail", nl: "Sterke analytische instelling met uitstekend oog voor detail" },
    { en: "Excellent communication, stakeholder management, and problem-solving skills", nl: "Uitstekende communicatieve vaardigheden, stakeholder management en probleemoplossend vermogen" },
    { en: "Able to work independently, manage deadlines, and coordinate with cross-functional teams", nl: "In staat om zelfstandig te werken, deadlines te beheren en af te stemmen met cross-functionele teams" },
    { en: "Nice to Have: Experience with SAP S/4HANA or Oracle Fusion is a plus", nl: "Nice to Have: Ervaring met SAP S/4HANA of Oracle Fusion is een pré" },
    { en: "Nice to Have: CIPS qualification or equivalent professional procurement certification is a plus", nl: "Nice to Have: CIPS-kwalificatie of gelijkwaardig professioneel inkoopcertificaat is een pré" },
    { en: "Nice to Have: Experience in category management or strategic sourcing is a plus", nl: "Nice to Have: Ervaring met category management of strategische sourcing is een pré" },
    { en: "Nice to Have: Familiarity with sustainability procurement practices and ESG supply chain objectives", nl: "Nice to Have: Bekendheid met duurzame inkooppraktijken en ESG-supply chain-doelstellingen" },
    { en: "Nice to Have: Experience working in an international or multicultural environment", nl: "Nice to Have: Ervaring in een internationale of multiculturele omgeving" },
    { en: "Nice to Have: Experience supporting procurement activities within operations, projects, supply chain, or ERP-driven environments", nl: "Nice to Have: Ervaring met het ondersteunen van inkoopactiviteiten binnen operations, projecten, supply chain of ERP-gedreven omgevingen" },
    { en: "Nice to Have: Experience working in both permanent employment and freelance/contract-based environments is a plus", nl: "Nice to Have: Ervaring in zowel vaste dienstverbanden als freelance-/contractomgevingen is een pré" },
  ],
},
    ],
  },
  ...
  description: {
    ...
    nl: "Locatie: Op locatie. Werktype: Fulltime, Contract. Bij Staff Outsourcing zijn we toegewijd aan het leveren van innovatieve en cutting-edge technologieoplossingen aan onze klanten. We richten ons op het benutten van AI en Machine Learning om intelligente systemen te bouwen die efficiëntie stimuleren en data-gedreven inzichten creëren. Word onderdeel van ons dynamische team van professionals waar jouw bijdrage direct impact heeft op de digitale transformatie van bedrijven.",
  },
  responsibilities: [
  ...
  requirements: [
    ...
    { en: "Nice to Have: Proficiency with version control systems like GitHub, including familiarity with workflows and collaborative coding practices", nl: "Nice to Have: Vaardigheid met versiebeheersystemen zoals GitHub, inclusief bekendheid met workflows en collaboratieve codepraktijken" },
    { en: "Nice to Have: Experience working with AWS cloud-native services such as S3, API Gateway, Lambda, ECS or equivalent services on MS Azure or Google Cloud", nl: "Nice to Have: Ervaring met AWS cloud-native services zoals S3, API Gateway, Lambda, ECS of gelijkwaardige services op MS Azure of Google Cloud" },
    { en: "Nice to Have: Strong communication skills in English, both written and verbal", nl: "Nice to Have: Sterke communicatieve vaardigheden in het Engels, zowel schriftelijk als mondeling" },
  ],
},
      {
  slug: "data-engineer",
  ...
  description: {
    ...
    nl: "Locatie: Op locatie. Werktype: Fulltime, Contract. Bij Staff Outsourcing zijn we trots op het leveren van cutting-edge data engineering-oplossingen op maat voor complexe bedrijfsbehoeften. Ons team van experts is toegewijd aan het benutten van geavanceerde technologieën en innovatieve strategieën om data-gedreven besluitvorming voor onze klanten te verbeteren. Word onderdeel van een dynamische en collaboratieve omgeving waar jouw bijdrage een betekenisvolle impact maakt. Als Data Engineer ontwerp en bouw je datapijplijnen ter ondersteuning van analytics en business intelligence.",
  },
  responsibilities: [
    { en: "Connecting new source systems to the customer data lake", nl: "Aansluiten van nieuwe bronsystemen op het data lake van de klant" },
    { en: "Migration of current ETL processes (DL 1.0) to the new Data Lake (DL 2.0)", nl: "Migratie van huidige ETL-processen (DL 1.0) naar het nieuwe Data Lake (DL 2.0)" },
    { en: "Implementation of monitoring and alerting mechanisms around the data lake ETLs to improve observability", nl: "Implementeren van monitoring- en alertingmechanismen rond de data lake ETL's om observability te verbeteren" },
    { en: "Performing monitoring activities and providing support in resolving ETL-related incidents in pre-production and production environments", nl: "Uitvoeren van monitoringactiviteiten en ondersteuning bieden bij het oplossen van ETL-gerelateerde incidenten in pre-productie- en productieomgevingen" },
  ],
  requirements: [
    { en: "Proficiency with Kafka event streaming – strong expertise required", nl: "Vaardigheid met Kafka event streaming – sterke expertise vereist" },
    { en: "Proficiency in SQL, Python, and PySpark – advanced knowledge necessary", nl: "Vaardigheid in SQL, Python en PySpark – geavanceerde kennis noodzakelijk" },
    { en: "Experience in working with ETL to data lake stages – hands-on experience required", nl: "Ervaring met ETL naar data lake-stadia – praktijkervaring vereist" },
    { en: "Experience with version control systems (GitHub) – familiarity with workflows", nl: "Ervaring met versiebeheersystemen (GitHub) – bekendheid met workflows" },
    { en: "Practical experience with CDK in Python (Infrastructure as Code)", nl: "Praktische ervaring met CDK in Python (Infrastructure as Code)" },
    { en: "Hands-on experience with AWS native services (Athena, Glue, Lambda, ECS)", nl: "Praktijkervaring met AWS native services (Athena, Glue, Lambda, ECS)" },
    { en: "DataOps, maintenance & support – ability to manage and optimize pipelines", nl: "DataOps, onderhoud & support – vermogen om pijplijnen te beheren en te optimaliseren" },
    { en: "Strong English communication skills (verbal and written)", nl: "Sterke communicatieve vaardigheden in het Engels (mondeling en schriftelijk)" },
    { en: "Precision and security awareness – attention to detail and secure coding practices", nl: "Precisie en securitybewustzijn – oog voor detail en veilige codepraktijken" },
    { en: "Conceptual and analytical thinking – ability to connect insights and patterns", nl: "Conceptueel en analytisch denken – vermogen om inzichten en patronen te verbinden" },
    { en: "Problem-solving and critical thinking – logical and structured approach to challenges", nl: "Probleemoplossend en kritisch denken – logische en gestructureerde aanpak van uitdagingen" },
    { en: "Familiarity with Agile Ways of Working (WoW), including time management, prioritization, and adaptability", nl: "Bekendheid met Agile Ways of Working (WoW), waaronder tijdmanagement, prioritering en aanpassingsvermogen" },
    { en: "Quality assurance (CI/CD) – experience with continuous integration and deployment", nl: "Kwaliteitsborging (CI/CD) – ervaring met continuous integration en deployment" },
    { en: "Basic knowledge of Redshift and Data Warehousing – understanding of ETL for BI purposes", nl: "Basiskennis van Redshift en Data Warehousing – begrip van ETL voor BI-doeleinden" },
    { en: "DevSecOps – experience with AWS security (IAM policies, security groups, etc.)", nl: "DevSecOps – ervaring met AWS-security (IAM-policies, security groups, enz.)" },
    { en: "Nice to Have: Familiarity with data quality practices, including validation and governance", nl: "Nice to Have: Bekendheid met datakwaliteitspraktijken, waaronder validatie en governance" },
    { en: "Nice to Have: Innovative mindset – willingness to explore and implement new solutions", nl: "Nice to Have: Innovatieve instelling – bereidheid om nieuwe oplossingen te verkennen en te implementeren" },
    { en: "Nice to Have: Domain knowledge in logistics and supply chain", nl: "Nice to Have: Domeinkennis in logistiek en supply chain" },
    { en: "Nice to Have: Dutch language proficiency – beneficial for communication with local stakeholders", nl: "Nice to Have: Beheersing van de Nederlandse taal – gunstig voor communicatie met lokale stakeholders" },
  ],
},
      {
  ...
  description: {
    ...
    nl: "Locatie: Heinkenszand en Roosendaal, Nederland. Werktype: Fulltime. Staff Outsourcing zoekt namens onze klant een toegewijde en zeer vaardige HVAC Service Technician voor een permanente, fulltime opdracht vanuit Heinkenszand en Roosendaal, Nederland. In deze essentiële technische rol ben je verantwoordelijk voor het onderhouden, optimaliseren en oplossen van storingen aan industriële HVAC- en koelinstallaties. Je speelt een cruciale rol in het waarborgen van de betrouwbaarheid, veiligheid en duurzaamheid van vitale processen binnen de Food-, Energie- en (semi-)industriële sectoren. Je operationele gebied omvat Zeeland, Noord-Brabant, de Belgische grensregio en af en toe Zuid-Holland. Deze functie vereist een onafhankelijke, verantwoordelijke professional met een sterk veiligheidsbewustzijn, die zelfstandig op locatie kan werken en fungeert als het primaire technische aanspreekpunt voor onze gewaardeerde klanten. In deze essentiële technische rol ben je verantwoordelijk voor het zelfstandig onderhouden, repareren en optimaliseren van mechanische HVAC-installaties binnen een industriële omgeving, waarbij je als ondernemer op locatie nauw samenwerkt met klanten en onderhoudsmonteurs.",
  },
  responsibilities: [
    { en: "Maintenance, Commissioning & Optimization", nl: "Onderhoud, inbedrijfstelling & optimalisatie" },
    { en: "Diagnostics & Compliance", nl: "Diagnose & naleving" },
    { en: "Client Relations & Technical Advisory", nl: "Klantrelaties & technisch advies" },
  ...
  requirements: [
    ...
    { en: "Possession of a valid F-gas Category 1 certificate (Required)", nl: "In het bezit van een geldig F-gassen Categorie 1 certificaat (Vereist)" },
    { en: "Proven experience in the service and maintenance of technical installations, preferably within an industrial environment", nl: "Aantoonbare ervaring in service en onderhoud van technische installaties, bij voorkeur in een industriële omgeving" },
    ...
    { en: "Nice to Have: F-gas A1 and/or B1 certification (additional F-gas certifications)", nl: "Nice to Have: F-gas A1 en/of B1 certificering (aanvullende F-gas certificaten)" },
    { en: "Nice to Have: Technical knowledge of electrical engineering or measurement and control technology", nl: "Nice to Have: Technische kennis van elektrotechniek of meet- en regeltechniek" },
  ],
},
      {
        slug: "hvac-service-technician",
  ...
  description: {
    ...
    nl: "Locatie: Spijkenisse, Nederland. Werktype: Fulltime. Staff Outsourcing zoekt namens onze klant een vaardige en toegewijde Heat Tracing Technician voor een permanente, fulltime opdracht in Spijkenisse, Nederland. In deze gespecialiseerde technische rol maak je deel uit van een expertteam dat verantwoordelijk is voor de installatie, het onderhoud en de optimalisatie van elektrische verwarmingssystemen (Heat Tracing). Deze kritieke systemen zorgen ervoor dat leidingnetwerken, tanks, fittingen en industriële oppervlakken nauwkeurig worden verwarmd of op de vereiste temperaturen worden gehouden om complexe industriële processen te waarborgen. Deze functie vereist een veiligheidsgerichte professional met een sterke basis in elektrotechniek, die eigenaarschap wil nemen over gespecialiseerde industriële apparatuur en tegelijkertijd de hoogste normen van operationele veiligheid en klanttevredenheid waarborgt.",
  },
  responsibilities: [
    { en: "Installation, Commissioning & Maintenance", nl: "Installatie, inbedrijfstelling & onderhoud" },
    { en: "Diagnostics & Operational Execution", nl: "Diagnose & operationele uitvoering" },
  ...
  requirements: [
    ...
    { en: "Previous experience in Heat Tracing is highly preferred, though comprehensive on-the-job training will be provided for candidates with a strong electrical background", nl: "Eerdere ervaring met Heat Tracing heeft sterk de voorkeur, maar uitgebreide on-the-job training wordt geboden aan kandidaten met een sterke elektrotechnische achtergrond" },
    { en: "Possession of a valid driver's license", nl: "In het bezit van een geldig rijbewijs" },
    { en: "Nice to Have: Entrepreneurial Mindset – takes true ownership of the craft, understanding the vital impact of Heat Tracing on complex industrial processes", nl: "Nice to Have: Ondernemende instelling – neemt echt eigenaarschap over het vak en begrijpt de vitale impact van Heat Tracing op complexe industriële processen" },
    { en: "Nice to Have: Team-Oriented & Independent – highly capable of working autonomously on-site while remaining deeply connected to a close-knit team of specialists", nl: "Nice to Have: Teamgericht & zelfstandig – zeer goed in staat om zelfstandig op locatie te werken en tegelijkertijd nauw verbonden te blijven met een hecht team van specialisten" },
  ],
},
    ],
  },
  ...
  responsibilities: [
    { en: "Core Delivery: Power BI Desktop", nl: "Kernlevering: Power BI Desktop" },
    { en: "Process Improvement: Power BI Service", nl: "Procesverbetering: Power BI Service" },
    { en: "Documentation & Reporting: DAX", nl: "Documentatie & rapportage: DAX" },
    { en: "Stakeholder Management: Power Query", nl: "Stakeholdermanagement: Power Query" },
    { en: "Team Collaboration: SQL", nl: "Teamsamenwerking: SQL" },
    { en: "Operational Excellence: SQL Server", nl: "Operationele excellentie: SQL Server" },
  ],
  requirements: [
    { en: "Bachelor's degree or equivalent professional experience related to the Power BI Developer role", nl: "Bachelordiploma of gelijkwaardige professionele ervaring gerelateerd aan de rol van Power BI Developer" },
    { en: "3+ years of relevant hands-on experience in a comparable role", nl: "3+ jaar relevante praktijkervaring in een vergelijkbare rol" },
    { en: "Nice to Have: Demonstrable ability to deliver strong results within the Data function", nl: "Nice to Have: Aantoonbaar vermogen om sterke resultaten te leveren binnen de Data-functie" },
  ],
},
    {
  slug: "it-specialist",
  ...
  responsibilities: [
    ...
    { en: "Network Setup & Security", nl: "Netwerkinrichting & security" },
    ...
    { en: "Local File Sharing & Backup Solutions", nl: "Lokale file-sharing & back-upoplossingen" },
    { en: "Employee Monitoring & IT Policies", nl: "Medewerkersmonitoring & IT-beleid" },
    { en: "IT Procurement & Asset Management", nl: "IT-inkoop & assetmanagement" },
    { en: "IT Automation & AI/Cloud Setup (Bonus Skills)", nl: "IT-automatisering & AI/cloud-setup (bonusvaardigheden)" },
  ],
  requirements: [
    ...
    { en: "Hands-on experience with Windows Server 2022, Active Directory, Microsoft Exchange Online, and file-sharing systems", nl: "Praktijkervaring met Windows Server 2022, Active Directory, Microsoft Exchange Online en file-sharing-systemen" },
    { en: "Strong knowledge of networking protocols, firewalls, and security best practices", nl: "Sterke kennis van netwerkprotocollen, firewalls en security best practices" },
    ...
    { en: "Experience with email security and spam filtering mechanisms (SPF, DKIM, DMARC)", nl: "Ervaring met e-mailbeveiliging en spamfiltermechanismen (SPF, DKIM, DMARC)" },
    { en: "Familiarity with Monitoring Solutions for activity monitoring and restriction", nl: "Bekendheid met monitoringoplossingen voor activiteitenmonitoring en -beperking" },
    { en: "Nice to Have: Ability to set up and maintain SMB/local file-sharing solutions", nl: "Nice to Have: Vermogen om SMB-/lokale file-sharing-oplossingen op te zetten en te onderhouden" },
    { en: "Nice to Have: Strong troubleshooting skills for hardware, software, and network issues", nl: "Nice to Have: Sterke troubleshootingsvaardigheden voor hardware-, software- en netwerkproblemen" },
    { en: "Nice to Have: Excellent documentation skills and ability to train employees on IT policies", nl: "Nice to Have: Uitstekende documentatievaardigheden en het vermogen om medewerkers te trainen in IT-beleid" },
  ],
},
      {
        ...
        description: {
          ...
          nl: "Bij Staff Outsourcing zijn we trots op ons vermogen om een vertrouwde partner te zijn voor bedrijven die strategische begeleiding en innovatieve oplossingen zoeken, met op maat gemaakte Oracle SCM-strategieën die operationele excellentie en duurzame groei stimuleren.",
        },
        responsibilities: [
  ...
  status: { en: "Active", nl: "Actief" },
  location: { en: "Staff Outsourcing, Mandenmakerstraat 100C, 3194 DG Hoogvliet Rotterdam, Netherlands", nl: "Staff Outsourcing, Mandenmakerstraat 100C, 3194 DG Hoogvliet Rotterdam, Nederland" },
  description: {
    en: "Location: Staff Outsourcing, Mandenmakerstraat 100C, 3194 DG Hoogvliet Rotterdam, Netherlands. Work Type: Internship. What We Offer: Learning & Support – Direct mentorship from seasoned AI developers, providing invaluable guidance and a structured learning experience on real-world projects. Flexibility & Team Exposure – An on-site role within a collaborative team environment, offering daily interaction and exposure to diverse perspectives and cutting-edge technologies. Growth & Career Development – Hands-on experience that builds a robust foundation for a career in AI, coupled with opportunities for professional coaching and insights into potential future roles. How to Apply: Interested candidates are invited to submit their application directly via the link below: https://talentgenie.vercel.app/careers/24",
    nl: "Locatie: Staff Outsourcing, Mandenmakerstraat 100C, 3194 DG Hoogvliet Rotterdam, Nederland. Werktype: Stage. Wat wij bieden: Leren & ondersteuning – Directe begeleiding van ervaren AI-ontwikkelaars, met waardevolle begeleiding en een gestructureerde leerervaring op real-world projecten. Flexibiliteit & teamexposure – Een on-site rol binnen een collaboratieve teamomgeving, met dagelijkse interactie en exposure aan diverse perspectieven en cutting-edge technologieën. Groei & loopbaanontwikkeling – Praktijkervaring die een solide basis legt voor een carrière in AI, gecombineerd met mogelijkheden voor professionele coaching en inzicht in potentiële toekomstige rollen. Solliciteren: Geïnteresseerde kandidaten worden uitgenodigd om hun sollicitatie rechtstreeks via onderstaande link in te dienen: https://talentgenie.vercel.app/careers/24",
  },
  responsibilities: [
    { en: "AI Model Development: Assist in the design, development, and implementation of Artificial Intelligence and Machine Learning models", nl: "AI-modelontwikkeling: Assisteren bij het ontwerpen, ontwikkelen en implementeren van Artificial Intelligence- en Machine Learning-modellen" },
    { en: "Application Building: Contribute to the creation and optimization of AI-powered applications and intelligent solutions", nl: "Applicatiebouw: Bijdragen aan het creëren en optimaliseren van AI-gedreven applicaties en intelligente oplossingen" },
    { en: "LLM Integration: Work with Large Language Models (LLMs) to explore and implement innovative use cases for business process automation", nl: "LLM-integratie: Werken met Large Language Models (LLM's) om innovatieve use cases voor bedrijfsprocesautomatisering te verkennen en implementeren" },
    { en: "Project Participation: Actively participate in the full lifecycle of AI projects, from conceptualization to deployment and optimization", nl: "Projectdeelname: Actief deelnemen aan de volledige levenscyclus van AI-projecten, van conceptualisering tot deployment en optimalisatie" },
    { en: "Research & Exploration: Conduct research on emerging AI technologies and methodologies to inform project development and strategies", nl: "Onderzoek & verkenning: Onderzoek doen naar opkomende AI-technologieën en -methodologieën om projectontwikkeling en -strategieën te onderbouwen" },
  ],
  requirements: [
    { en: "Experience: A strong interest in Artificial Intelligence, Machine Learning, and software development, demonstrated through academic projects, coursework, or personal initiatives", nl: "Ervaring: Een sterke interesse in Artificial Intelligence, Machine Learning en softwareontwikkeling, aangetoond via academische projecten, vakken of persoonlijke initiatieven" },
    { en: "Education: Currently pursuing a Bachelor's or Master's degree in Computer Science, Artificial Intelligence, Machine Learning, Data Science, or a closely related technical field", nl: "Opleiding: Momenteel bezig met een bachelor- of masteropleiding in Computer Science, Artificial Intelligence, Machine Learning, Data Science of een nauw verwant technisch vakgebied" },
    { en: "Technical Skills: Familiarity with programming languages such as Python; understanding of machine learning concepts and frameworks (e.g., TensorFlow, PyTorch); basic knowledge of data structures and algorithms. Exposure to Large Language Models (LLMs) is a plus", nl: "Technische vaardigheden: Bekendheid met programmeertalen zoals Python; begrip van machine learning-concepten en -frameworks (bijv. TensorFlow, PyTorch); basiskennis van datastructuren en algoritmen. Exposure aan Large Language Models (LLM's) is een pré" },
    { en: "Soft Skills: Excellent problem-solving abilities, eagerness to learn, strong analytical thinking, and effective communication skills to collaborate within a team environment", nl: "Soft skills: Uitstekende probleemoplossende vaardigheden, leergierigheid, sterk analytisch denken en effectieve communicatieve vaardigheden om binnen een teamomgeving samen te werken" },
  ],
},
    ],
  },
