...
export default async function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="relative w-full bg-gradient-to-br from-[#0d2b33] via-[#1a4550] to-[#0d2b33] text-white py-24 px-4 sm:px-8 lg:px-16 text-center overflow-hidden">
      ...
      {/* What This Means in Practice */}
<section className="py-20 px-4 sm:px-8 lg:px-16 bg-[#0d2b33] border-t border-b border-[#1a4550]/10">
  <div className="max-w-4xl mx-auto text-center space-y-6">
    <span className="inline-block text-xs font-bold tracking-widest uppercase text-[#f2c40d] bg-white/10 px-3 py-1.5 rounded-full">
      {t("practice.badge")}
    </span>
    ...
    <div className="pt-4">
      <Link href="/our-approach" className="inline-flex items-center gap-2 bg-[#f2c40d] text-[#0d2b33] px-6 py-3 rounded-xl font-semibold text-sm hover:bg-white transition-all shadow-md">
