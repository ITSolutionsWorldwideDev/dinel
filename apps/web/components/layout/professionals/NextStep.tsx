      ...
      <div className="bg-gray-100 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href={"/vacancies"}>
              <button className="bg-[#FF6B35] hover:bg-orange-600 text-white font-semibold px-8 py-3  shadow-md transition-all duration-300 hover:shadow-lg w-full sm:w-auto cursor-pointer">
                View Vacancies
              </button>
            </Link>
