// apps/web/components/candidates/CandidateProfile.tsx
"use client";
    ...
    <>
      <div className="page-wrapper">
        <div className="content">
          <div className="page-header flex justify-between items-center mb-4 border-b-2 rounded-lg p-4 text-white bg-[#FF8026]">
            <div>
              <h4 className="text-lg font-semibold">Profile Preview</h4>
              <h6 className="">Manage candidate profile</h6>
            </div>
          </div>
